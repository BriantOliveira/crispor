...
def len_indel(cigar):
    # calulates the length of the cigar string by simply adding the numbers in
    # the cigar string. more sophisticated approaches might be possible and 
    # might need to be investigated.
    #
    # eg: len_indel(6M1D14M) = 21
    # 
    # args:
    ...
    lengths = [int(num) for num in re.findall(r"\d+", cigar)]
    return sum(lengths)
...
for line in sys.stdin:
    ...
    if cigar=="20M":
        ...
        endPos = startPos+len_indel(cigar)
